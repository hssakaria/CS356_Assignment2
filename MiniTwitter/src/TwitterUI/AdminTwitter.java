...
public class AdminTwitter  {
	...
	private GroupUser currentGPNode;
	...
	private void initialize() {
		...
		groupAddBtn.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				DefaultMutableTreeNode node = 
						(DefaultMutableTreeNode) treeView.getLastSelectedPathComponent();
					currentGPNode = (GroupUser) node.getUserObject();
				if(!id.equals("") && node != null){
	 ...
	 ********************************************************/
//	public GroupUser getSelectedGroupUserNode() {
//
//		if ((currentNode != null) && (currentNode instanceof GroupUser)) {
//			currentGroupUserNode = currentNode;
//		}
//		else {
...
//	}
	...
	public GroupUser getSelectedGroupUserNode() {
		...
		if ((currentNode != null) && (currentGPNode instanceof GroupUser)) {
			currentGroupUserNode = currentGPNode;
		}
		else {
			currentGroupUserNode = rootGroup;
		}
